...
//       cabinets: ['1', '2'],
//
//       // id_parent: null, // Пример значения для id_parent
//       // title: 'hddddhh',
//       // description: 'Хотим подняться на гору',
//       // shortname: 'dddd2',
//       // leaders: [1, 2, 3], // Пример значений для leaders (массив чисел)
//       // cabinets: ['cabinet1', 'cabinet2'], // Пример значений для cabinets (массив строк)
//       // cabinet: 'cabinet', // Пример значения для cabinet
//       // document: 'hddddhh',
//       // charterTeam: 'dddddd',
//       // userID: 5,
//       // cabinetsAsNumbers: [1, 2, 3], // Пример значений для cabinetsAsNumbers (массив чисел)
//     };
//
//     it('Если краткое название коллектива превышает 50 символов, то пользователь получит предупреждение об ошибке', async () => {
//       createTeamDto.shortname = 't'.repeat(51);
